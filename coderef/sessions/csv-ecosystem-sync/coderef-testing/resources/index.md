# Resources Index - coderef-testing Agent
...
## Project Scope
- **Agent Home:** `C:\Users\willh\.mcp-servers\coderef-testing`
- **Scope:** coderef-testing MCP server
- **Scan Targets:** server.py (tools), .claude/commands/, scripts/
...
## Output
- `outputs/coderef-testing-audit-report.json`

**Session Path:** `C:\Users\willh\.mcp-servers\coderef\sessions\csv-ecosystem-sync\coderef-testing`
**Phase:** phase_1
