...
def get_server_version() -> str:
    """
    Get the coderef-docs server version.

    Returns:
        str: Version string in format 'coderef-docs vX.Y.Z' or 'unknown' if not found
    ...
    try:
        ...
        if server_py.exists():
            ...
            if version_match:
                return f"coderef-docs v{version_match.group(1)}"
        ...
        return "coderef-docs v3.1.1"  # Current version as fallback
