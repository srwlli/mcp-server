...
import re
import time
# from type_defs import ValidationResultDict, ValidationIssueDict  # TODO: Add type defs
# from logger_config import logger  # TODO: Add logger
import logging
logger = logging.getLogger(__name__)

# Schema path relative to project root
SCHEMA_PATH = Path(__file__).parent.parent.parent / "schemas" / "planning" / "plan.schema.json"
