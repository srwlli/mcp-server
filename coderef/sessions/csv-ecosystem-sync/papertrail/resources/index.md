# Resources Index - papertrail Agent
...
- **Scan Targets:** server.py (tools), validators/, schemas/
...
## Output
- `outputs/papertrail-audit-report.json`

**Session Path:** `C:\Users\willh\.mcp-servers\coderef\sessions\csv-ecosystem-sync\papertrail`
**Phase:** phase_1
