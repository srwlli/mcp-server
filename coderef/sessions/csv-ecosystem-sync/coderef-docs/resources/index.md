# Resources Index - coderef-docs Agent
...
- **Scan Targets:** server.py (tools), .claude/commands/, scripts/, validators/
...
## Output
- `outputs/coderef-docs-audit-report.json`

**Session Path:** `C:\Users\willh\.mcp-servers\coderef\sessions\csv-ecosystem-sync\coderef-docs`
