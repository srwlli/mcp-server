# Resources Index - coderef-assistant Agent
...
## Project Scope
- **Agent Home:** `C:\Users\willh\Desktop\assistant`
- **Scope:** Assistant orchestrator project
- **Scan Targets:** .claude/commands/, coderef/working/, scripts/
...
## Output
- `outputs/coderef-assistant-audit-report.json`

**Session Path:** `C:\Users\willh\.mcp-servers\coderef\sessions\csv-ecosystem-sync\coderef-assistant`
**Phase:** phase_1
