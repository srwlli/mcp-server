# Resources Index - coderef-personas Agent
...
## Project Scope
- **Agent Home:** `C:\Users\willh\.mcp-servers\coderef-personas`
- **Scope:** coderef-personas MCP server
- **Scan Targets:** server.py (tools), .claude/commands/, personas/
...
## Output
- `outputs/coderef-personas-audit-report.json`

**Session Path:** `C:\Users\willh\.mcp-servers\coderef\sessions\csv-ecosystem-sync\coderef-personas`
**Phase:** phase_1
